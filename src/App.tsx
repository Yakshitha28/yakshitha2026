...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-[#0a0a0c] text-[#f3f4f6] relative selection:bg-cyan-500/30 selection:text-cyan-200">
      {/* Dynamic ambient background gradients & subtle tech backdrop */}
      <div className="fixed inset-0 pointer-events-none z-0 overflow-hidden">
        <div
          className="absolute inset-0 bg-cover bg-center opacity-[0.06] mix-blend-screen"
      ...
      <div className="relative z-10">
        ...
        {/* Projects Grid (Featured: L'Amore Restaurant) */}
